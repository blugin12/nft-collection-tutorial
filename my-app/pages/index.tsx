...
export default function Home() {
  ...
  const [walletConnected, setWalletContracted] = useState(false);
  const [numTokensMint, setNumTokensMinted] = useState("");
  ...
  function renderBody() {
    ...
    if (presaleEnded) {
      return (
        <div>
          <span className={styles.description}>
            Presale has ended. You can mint a CryptoDev in 
            public sale, if any remain.
          </span>
    ...
    <div>
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            {numTokensMint}/20 have been minted
          </div>
          {renderBody()}
        </div>
        <div>
